...
/**
 * Este método se encarga de calcular la prima
 * que le corresponde al empleado. Si es directivo, si los meses
 * son iguales o mayores a 12, devolverá P1 y sino, devolverá
 * P3. Si no es directivo, si los meses son iguales o mayores a 12
 * devolverá P2 y sino devolverá P4.
 * @param esDirectivo es un parámetro de tipo carácter, que indica 
 * si el empleado es o no directivo.
 * meses es un parámetro de tipo entero, que indica el número de
 * meses
 ...
 */
	...
	/**
	 * Este método se encarga de leer por teclado el número de empleado,
	...
	/**
	 * Este método se encarga de leer por teclado el nombre del empleado,
	 * que tiene que tener máximo 10 caracteres.
	...
	/**
	 * Este método se encarga de leer por teclado los meses de trabajo del empleado,
	 * que no pueden ser menores que 0.
	 * @return el número de meses trabajados por el empleado.
	 */
	...
	/**
	 * Este método se encarga de leer por teclado si el empleado es directivo (+) o no (-)-
